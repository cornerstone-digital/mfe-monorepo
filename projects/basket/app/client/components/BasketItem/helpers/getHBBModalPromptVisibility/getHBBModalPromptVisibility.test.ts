...
import getHBBModalPromptVisibility from './getHBBModalPromptVisibility'
...
describe('getHBBModalPromptVisibility', () => {
  const mockPackageId = '3a1ea657-3ee8-4375-84c8-929f5f14588c'
  describe('should return false', () => {
    test('if basket is empty object', () => {
      const mockBasket = {}
      expect(getHBBModalPromptVisibility(mockBasket, mockPackageId)).toBe(false)
    })
  ...
  describe('should return true', () => {
    ...
    `('if package is $packageType', ({ planType }) => {
      ...
      expect(getHBBModalPromptVisibility(mockBasket, mockPackageId)).toBe(true)
    })
  })
})
