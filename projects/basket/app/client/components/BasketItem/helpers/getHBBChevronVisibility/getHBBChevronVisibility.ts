...
const getHBBChevronVisibility = (basket?: BasketV2.Basket, packageId?: BasketV2.ModelPackage['packageId']) => {
  const targetVariant3_HBB = getABTestFeatureValue('planChevronABHBB')

  if (!targetVariant3_HBB) {
    return false
  }
...
export default getHBBChevronVisibility
